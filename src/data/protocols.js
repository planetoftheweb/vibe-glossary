  ...
  topics: [
    {
      ...
      summary:
        'A protocol is a shared set of conversation rules for computers. HyperText Transfer Protocol (HTTP) moves web requests, Simple Mail Transfer Protocol (SMTP) moves email, and Model Context Protocol (MCP) connects AI assistants to tools.',
      details:
    ...
    },
    {
      ...
      summary:
        'HyperText Transfer Protocol (HTTP) is the web\'s question-and-answer system. A browser sends a request and a server returns a response with a status number. HTTPS encrypts that same conversation so other people cannot read it in transit.',
      details:
    ...
    },
    {
      ...
      summary:
        'Live features need a way to receive new information. Polling asks again on a timer. Server-sent events keep a one-way feed open. WebSockets keep a two-way connection open so both sides can speak at any time.',
      details:
